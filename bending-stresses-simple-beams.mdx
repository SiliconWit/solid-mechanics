...
This lesson pairs with the [Beam Analysis Simulator](/product-development/beam-analysis-simulator/): choose a cross-section and watch the maximum bending stress respond as you change the load and the section dimensions. The [Beam Analysis Experiments](/education/mechanics-of-materials/beam-analysis-experiments) reproduce the worked examples step by step with Python.
:::
...
Set this beam and section in the simulator and read the maximum bending stress directly:
...
:::tip[Instrument it]
Bending stress is invisible, but the strain that rides with it is not. Bond a foil strain gauge to the extreme fibre on the tension face at the section of maximum moment; the strain times Young's modulus is the bending stress you computed from Mc/I. A quarter-bridge read by an [ESP32 or STM32](/education/sensor-actuator-interfacing-stm32/) turns the flexure formula into a measured value you can [trend on siliconwit.io](https://siliconwit.io) and check against the allowable before the part takes a permanent set.
:::
