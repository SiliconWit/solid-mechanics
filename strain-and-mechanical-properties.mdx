...
![Panel (a): the area under the entire stress-strain curve shaded, labelled as the modulus of toughness, the integral of stress with respect to strain up to fracture. Panel (b): the magnified elastic triangle under the elastic line up to yield, labelled as the modulus of resilience, sigma yield squared over 2E](./images/stress-strain-energy-areas.svg)
